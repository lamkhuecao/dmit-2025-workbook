<form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="border border-secondary-suble rounded shadow-sm p-3">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="city_name" id="city_name" class="form-control" value="<?php
    ...
    <div class="mb-4">
        ...
        <input type="text" name="population" id="population" class="form-control" value="<?php
    ...
    <fieldset class="mb-4">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="capital" id="is-capital" value="1"
                <?= $capital === '1' ? 'checked' : ''; ?>>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="capital" id="not-capital" value="0"
                <?= $capital === '0' ? 'checked' : ''; ?>>
    ...
    <div class="mb-4">
        ...
        <input type="text" name="trivia" id="trivia" class="form-control" value="
        <?php
